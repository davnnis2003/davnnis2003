...
- Built Operations BI squad from 0→2 engineers at Vestiaire Collective; defined team structure with COO/VP Ops
...
- **[Agile for Data Teams](https://jimmypang.medium.com/)** - Framework for Scrum/Kanban in analytics workflows (reduced backlog 8→4 weeks)
- **[P0 Data Asset Classification](https://jimmypang.medium.com/)** - Automated criticality detection using dbt Exposures
...
- **400+ dbt Models** - Serving 7 business domains (Trust & Safety, Payments, CS, Operations, Sustainability)
...
|---------|------|----------------|
| **Vestiaire Collective** | BI & AE Lead | €24M payment redesign, 80% fraud reduction, built BI squad from 0→2 engineers |
...
- **400+** production dbt models in enterprise data warehouse
- **200+** business users supported across self-service data platforms
- **0→2** analytics engineers hired & mentored at Vestiaire Collective
...
- 🎯 **0→1 Data Team Building** - Hiring, onboarding, and scaling frameworks for early-stage companies
- 🤖 **LLM-Powered Analytics** - Integrating AI agents (semantic search, automated documentation) into modern data stacks
- 🚀 **Growth Analytics Playbooks** - eCommerce/logistics optimization patterns from 8+ years at HelloFresh/Delivery Hero/Vestiaire
- 🏗️ **Data Mesh Implementation** - Decentralized data ownership for 50-200 person engineering orgs
...
**Work Authorization:** German Permanent Residence (Niederlassungserlaubnis)
